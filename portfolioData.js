...
PortfolioData.push({
	images: [
	  '/images/portfolio/caltoco/logo.png',
	  '/images/portfolio/caltoco/0.JPG',
	  '/images/portfolio/caltoco/1.JPG',
	],
	tags: [
		'caltoco'
	],
	name: "caltoco",
	full_name: "Caltoco",
	href: "http://www.caltoco.cl/",
	text: "<p>plafeholder</p>",
});

PortfolioData.push({
	images: [
	  '/images/portfolio/policyportal/logo.png',
	  '/images/portfolio/policyportal/0.JPG',
	  '/images/portfolio/policyportal/1.JPG',
	],
	tags: [
		'policyportal'
	],
	name: "policyportal",
	full_name: "Policy Portal",
	href: "http://policyportal.co.uk/",
	text: "<p>plafeholder</p>",
});

PortfolioData.push({
	images: [
	  '/images/portfolio/victoriaoilandgas/logo.png',
	  '/images/portfolio/victoriaoilandgas/0.JPG',
	  '/images/portfolio/victoriaoilandgas/1.JPG',
	  '/images/portfolio/victoriaoilandgas/2.JPG',
	],
	tags: [
		'victoriaoilandgas'
	],
	name: "victoriaoilandgas",
	full_name: "Victoria Oil And Gas",
	href: "http://www.victoriaoilandgas.com/",
	text: "<p>plafeholder</p>",
});

PortfolioData.push({
	images: [
	  '/images/portfolio/templebar/logo.png',
	  '/images/portfolio/templebar/0.JPG',
	  '/images/portfolio/templebar/1.JPG',
	],
	tags: [
		'templebar'
	],
	name: "templebar",
	full_name: "Temple Bar",
	href: "http://templebar.london/",
	text: "<p>plafeholder</p>",
});

PortfolioData.push({
	images: [
	  '/images/portfolio/quickflick/logo.png',
	  '/images/portfolio/quickflick/0.JPG',
	  '/images/portfolio/quickflick/1.JPG',
	],
	tags: [
		'quickflick'
	],
	name: "quickflick",
	full_name: "Quickflick",
	href: "http://quickflick.tv/",
	text: "<p>plafeholder</p>",
});

PortfolioData.push({
	images: [
	  '/images/portfolio/vmi/logo.png',
	  '/images/portfolio/vmi/0.JPG',
	  '/images/portfolio/vmi/1.JPG',
	  '/images/portfolio/vmi/2.JPG',
	],
	tags: [
		'vmi'
	],
	name: "vmi",
	full_name: "VMI",
	href: "https://www.vmi.lt/renginiai/",
	text: "<p>plafeholder</p>",
});
